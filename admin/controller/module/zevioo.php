...
class ControllerModuleZevioo extends Controller {
	...
	public function install() {
		...
		$this->model_tool_event->addEvent('zevioo_add_order', 'post.order.add', 'module/zevioo/eventAddOrder');
		$this->model_tool_event->addEvent('zevioo_edit_order', 'post.order.history.add', 'module/zevioo/eventEditOrder');	
	}
	
	public function uninstall() {
        $this->load->model('tool/event');
		$this->model_tool_event->deleteEvent('zevioo_add_order');
		$this->model_tool_event->deleteEvent('zevioo_edit_order');
    }
